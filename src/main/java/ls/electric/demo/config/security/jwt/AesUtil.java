...
public class AesUtil {
    ...
    private static final int iterationCount = 10000; //암호화 관련키 (PEBKey) 생성 횟수

    //키값의 경우, 실 사용시 getRandomHexString(32), getRandomHexString(16)을 사용해 랜덤하게 생성
    //해시값 무작위성을 높이기 위한 보조키 (32자리 Hex)
    private static String salt = "79752f1d3fd2432043c48e45b35b24645eb826a25c6f1804e9152665c345a552";
    //AES 암호화 메인키 (16자리 Hex)
